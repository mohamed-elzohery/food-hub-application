...
const Meal = forwardRef((props, ref) => {
  ...
  const onDecHandler = () => {
    ...
    const onAddHandler = () => {
        ...
        dispatch(UIActions.addNotification({msg: `${title} is added to cart.`, id: notificationId}));
        setTimeout(() => dispatch(UIActions.removeNotification({id: notificationId})),3000);
    }

    return <div className={classes.meal} ref={ref}>
